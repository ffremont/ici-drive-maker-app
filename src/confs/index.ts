...
const other: Configuration = {
    ...
    defaultStartDriveAfterDays:1,
    youtubeTuto: 'https://www.youtube.com/channel/UC0EhN7oUOnTcVHU3ek2xtzA/',
    youtubeStepActivity:'https://youtu.be/jtWYZIYsT9o',
    youtubeStepDelivery: 'https://youtu.be/jtWYZIYsT9o',
    youtubeStepDrive: 'https://youtu.be/jtWYZIYsT9o',
